...
export function AboutSection() {
  ...
  return (
    <section
      id="nosotros"
      className="relative py-20 flex justify-center overflow-hidden bg-center bg-cover"
      style={{
        backgroundImage: "url('/Fondo_Inicios/fondo mision.png')",
      }}
    >
      {/* Capa oscura */}
      <div className="absolute inset-0 bg-black/20"></div>

      <div className="relative w-full max-w-6xl px-10 sm:px-10 text-white">
        <motion.div
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-5">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <Card className="h-full bg-white/90 backdrop-blur">
              <CardContent className="p-8 text-black">
                ...
                <p className="text-lg mb-8">
                  Somos una empresa argentina fundada en 1961 dedicada a brindar soluciones integrales al transporte pesado.
                </p>
                ...
                <p className="text-lg">
                  Ser la marca líder en soluciones integrales para el transporte en Argentina.
                </p>
              </CardContent>
            </Card>
          </motion.div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 text-center">
              {values.map((value, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className={`p-4 ${index === 4 ? "sm:col-span-2 lg:col-span-1" : ""}`}
                >
